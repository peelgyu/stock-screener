...
window.STOCKINTO_TERMS = {
  ...
  "DCF": {
    def: "현금흐름할인법. 미래 FCF를 현재가치로 환산해 적정주가 추정. StockInto는 종목별 WACC을 할인율로, 영구성장률 1.5%(인플레 이하)를 적용해 보수적으로 산출.",
    more: "dcf"
  },
  "WACC": {
    def: "가중평균자본비용. (자기자본비중 × 자본비용) + (부채비중 × 차입이자율 × (1-법인세)). DCF 할인율로 사용. 종목별 베타·재무구조에 따라 7.5~14% 범위.",
    more: "wacc"
  },
  "CAPM": {
    def: "자본자산가격결정모형. 자기자본비용 = 무위험수익률 + 베타 × 시장위험프리미엄. 무위험률 미국 10Y ~4.3%, 시장프리미엄 5.5% 적용.",
    more: "capm"
  },
  "베타": {
    def: "시장 대비 변동성. 1.0=시장과 동일, 1.5=시장보다 50% 더 출렁, 0.7=시장의 70%만 움직임. 고베타 종목은 자본비용·할인율도 높음.",
    more: "beta"
  },

  // 한국 시장 수급
  "외국인 보유율": {
    def: "외국인이 보유한 주식이 상장주식 총수에서 차지하는 비율. 한국거래소 일별 공시. 외국인 자금이 늘면 통상 주가 상승 압력. 한도 소진률 90%+면 추가 매수 어려움.",
    more: "foreign-ownership"
  },
  "공매도": {
    def: "주식을 빌려 팔고 나중에 갚는 거래. 잔고가 늘면 하락 베팅 우세 신호, 줄면 숏커버링(청산) 진행 중. 상장 대비 2%+면 의미 있는 수준.",
    more: "short-selling"
  },
  "Graham": {
